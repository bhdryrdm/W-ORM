...
namespace EF_DBFirst.MSSQL
{
    ...
    public partial class NORTHWNDEntities : DbContext
    {
        ...
        public NORTHWNDEntities() : base("name=NORTHWNDEntities") // App.Config yada Web.Config dosyalarındaki ConnectinonString
        {
            Configuration.LazyLoadingEnabled = false; // İlişkili veriler getirilmeyecek
        }
